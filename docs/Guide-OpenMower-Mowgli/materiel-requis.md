...
📦 [Voir la section Impressions 3D](/docs/Guide-OpenMower-Mowgli/impressions-3d/)
...
> ✅ Ce schéma est également modifiable au format `.drawio` dans la page dédiée : [Voir le schéma interactif](/schema/)
